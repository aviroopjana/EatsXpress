...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#fed754] to-[#edbd41] py-8">
      <div className="w-full flex flex-col  md:max-w-6xl mx-auto sm:flex sm:flex-row justify-between items-start">
        {/* Logo Section */}
        <div className="flex flex-col gap-3 items-start">
          <div className="text-xl md:text-3xl font-bold flex flex-row items-center ml-7">
            {" "}
            <img src={logo} alt="logo" className="h-20 w-20" /> EatsXpress
          </div>
          <p className="w-40 items-center justify-center ml-20">
            Our mission is to make healthy eating easy and convenient for busy
            individual and families
          </p>
          <div className="flex flex-row ml-20 mt-4 gap-3">
            <ImInstagram />
            <FaFacebook />
            <BsTwitterX />
            <BsWhatsapp />
        ...
        {/* Company Section*/}
        <div className="text-center md:my-20 mt-4 ml-20 md:ml-7">
        ...
        <div className="text-center md:my-20 mt-4 ml-16 md:ml-7">
        ...
        {/* Contact Section*/}
        <div className="text-center md:my-20 mt-4 ml-7">
